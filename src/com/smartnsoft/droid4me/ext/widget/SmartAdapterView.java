 ...
 * @since 2009.02.15
 */
public abstract class SmartAdapterView<T extends Adapter>
    extends ViewGroup
{
  ...
  public SmartAdapterView(Context context, AttributeSet attrs)
  {
    super(context, attrs);
  }

  public SmartAdapterView(Context context, AttributeSet attrs, int defStyle)
  {
  ...
  /**
   * When the current adapter is empty, the AdapterView can display a special view call the empty view. The empty view is used to provide feedback to
      ...
      extends DataSetObserver
  {
    ...
    public void onChanged()
    {
      ...
      if (SmartAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0 && mItemCount > 0)
      {
        SmartAdapterView.this.onRestoreInstanceState(mInstanceState);
        mInstanceState = null;
      }
      else
      {
    ...
    public void onInvalidated()
    {
      ...
      if (SmartAdapterView.this.getAdapter().hasStableIds())
      {
        // Remember the current state for the case where our hosting activity is being
        // stopped and later restarted
        mInstanceState = SmartAdapterView.this.onSaveInstanceState();
      }
  ...
  /**
   * Searches the adapter for a position matching mSyncRowId. The search starts at mSyncPosition and then alternates between moving up and moving down
