 ...
 */
//@Widget
public class SmartGallery extends SmartAbsSpinner implements GestureDetector.OnGestureListener {
/**
 ...
 */
   ...
   */
  /**
   * Indicates whether the gallery should not not listen to {@link #requestLayout()} calls.
   * 
   * <p>This enables to work-around the bug of the {@link Gallery} source-code when changing the {@link android.graphics.Drawable} of a child {@link ImageView}.</p>
   */
  public void discardLayoutRequests(boolean value)
  {
    mBlockLayoutRequests = value;
  }
  /**
   * end: Édouard modified
   */
    ...
    public SmartGallery(Context context) {
        this(context, null);
    }

    public SmartGallery(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.galleryStyle);
    }

    public SmartGallery(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
         ...
         */
        return new SmartGallery.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    @Override
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //Log.d("SMART", "onLayout()");
     ...
     */
        ...
        if (selView.getLeft() <= galleryCenter && selView.getRight() >= galleryCenter) {
            //Log.d("SMART", "same pos: mSelectedPosition=" + mSelectedPosition  + " selView.getLeft()=" + selView.getLeft() + " galleryCenter="+ galleryCenter + " selView.getRight()="+selView.getRight());
            return;
        }
    ...
    void layout(int delta, boolean animate) {
        //Log.d("SMART", "layout(delta=" + delta);
        ...
        if (mNextSelectedPosition >= 0) {
            //Log.d("SMARTL", "setSelectedPositionInt(" + mNextSelectedPosition+")");
     ...
     * end: Édouard modified
     */
        //Log.d("SMART", "fillToGalleryRight");
        int itemSpacing = mSpacing;
        /**
         * Édouard modified: start
         */
        ...
        while (curLeftEdge < galleryRight && curPosition < numItems) {
            //Log.d("SMART", "fillToGalleryRight: curLeftEdge="+curLeftEdge+" galleryRight="+galleryRight);
            prevIterationView = makeAndAddView(curPosition, curPosition - mSelectedPosition,
                    curLeftEdge, true);
     ...
     * Édouard modified: start
     */
    View makeAndAddView(int position, int offset, int x,
            boolean fromLeft) {
    /**
     * end: Édouard modified
     */
     ...
     * Édouard modified: start
     */
    void setUpChild(View child, int offset, int x, boolean fromLeft) {
    /**
     * end: Édouard modified
     */
        ...
        // make some up...
        SmartGallery.LayoutParams lp = (SmartGallery.LayoutParams) 
            child.getLayoutParams();
        if (lp == null) {
            lp = (SmartGallery.LayoutParams) generateDefaultLayoutParams();
        }
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
         ...
         * Édouard modified: start
         */
        trackMotionScroll(-1 * (int) distanceX, -1 * (int) distanceY, e1, e2);
        /**
         * end: Édouard modified
         */
    ...
    void setSelectedPositionInt(int position) {
        //Log.d("SMART", "setSelectedPositionInt(" + position);
     ...
     */
        ...
        public void run() {
             ...
             * Édouard modified: start
             */
            trackMotionScroll(delta, 0, null, null);
            /**
             * end: Édouard modified
             */
