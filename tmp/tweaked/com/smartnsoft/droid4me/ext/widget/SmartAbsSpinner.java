 ...
 * @since 2009.02.15
 */
public abstract class SmartAbsSpinner extends SmartAdapterView<SpinnerAdapter> {
    ...
    public SmartAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public SmartAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmartAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
    ...
    void recycleAllViews() {
        ...
        final SmartAbsSpinner.RecycleBin recycleBin = mRecycler;
    ...
    void setSelectionInt(int position, boolean animate) {
        if (position != mOldSelectedPosition) {
            //Log.d("SMARTB", "setSelectionInt(position="+position);
            mBlockLayoutRequests = true;
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link SmartAbsSpinner#onSaveInstanceState()}
         */
